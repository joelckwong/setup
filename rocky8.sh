...
sudo curl -Lo docker-compose "https://github.com/docker/compose/releases/download/v2.23.3/docker-compose-$(uname -s)-$(uname -m)"
sudo install -o root -g root -m 0755 docker-compose /usr/bin/docker-compose
curl --silent --location https://get.helm.sh/helm-v3.13.2-linux-amd64.tar.gz | tar xvz
