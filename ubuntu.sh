...
curl https://releases.hashicorp.com/packer/1.3.2/packer_1.3.2_linux_amd64.zip --output packer_1.3.2_linux_amd64.zip
sudo unzip packer_1.3.2_linux_amd64.zip -d /usr/bin
